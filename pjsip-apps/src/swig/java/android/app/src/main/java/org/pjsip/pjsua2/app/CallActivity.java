...
public class CallActivity extends Activity
    ...
    private static final VideoPreviewHandler previewHandler =
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonShowPreview = findViewById(R.id.buttonShowPreview);
    ...
    private void updateCallState(CallInfo ci) {
        TextView tvPeer = findViewById(R.id.textViewPeer);
