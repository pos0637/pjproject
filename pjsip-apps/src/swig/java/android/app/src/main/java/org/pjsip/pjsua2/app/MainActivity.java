...
public class MainActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CheckPermission
                .from(this)
                .setPermissions(Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.ACCESS_NETWORK_STATE, Manifest.permission.CAMERA)
                .setRationaleConfirmText("请求权限")
                .setDeniedMsg("拒绝请求权限")
                .setPermissionListener(new PermissionListener() {
                    ...
                    public void permissionDenied() {
                        ToastUtils.showLong("未获取到必要权限,程序无法正常工作!");
                    }
                })
                .check();
        ...
        buddyListView = findViewById(R.id.listViewBuddy);
    ...
    private void dlgAccountSetting() {
        ...
        final EditText etId = view.findViewById(R.id.editTextId);
        final EditText etReg = view.findViewById(R.id.editTextRegistrar);
        final EditText etProxy = view.findViewById(R.id.editTextProxy);
        final EditText etUser = view.findViewById(R.id.editTextUsername);
        final EditText etPass = view.findViewById(R.id.editTextPassword);
        ...
        adb.setPositiveButton("OK",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        acc_id = Constants.getSipAccountId();
                        registrar = Constants.getRegistrar();
    ...
    private void dlgAddEditBuddy(BuddyConfig initial) {
        ...
        final EditText etUri = view.findViewById(R.id.editTextUri);
        final CheckBox cbSubs = view.findViewById(R.id.checkBoxSubscribe);
